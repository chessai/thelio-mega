# Generic colour maths: hex <-> rgb <-> hsv, plus brighten/darken.
# No palette lives here; the seed colours are the `colorscheme` module's
# business (see home/colorscheme.nix).
{ lib }:
